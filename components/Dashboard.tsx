...
import FinancialView from './views/FinancialView.tsx';
...
const Dashboard: React.FC<DashboardProps> = ({ user, onLogout }) => {
    ...
    const { courses, assignments, exams, grades, resources, messages, calendarEvents, loading, unreadChatCount, financialStatus } = useRealtimeData(user);
    ...
    const renderView = () => {
        switch (activeView) {
            ...
            case View.Financial:
                return <FinancialView user={user} />;
